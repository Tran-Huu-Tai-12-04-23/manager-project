...
function FormAddNewProject({ action = (e) => {}, type, data }) {
    ...
    const handleAddNewInFoProject = async () => {
        ...
        const result = await Service.callApi('/project/create-new-info-project', formData);
    ...
    const handleUpdateProject = async () => {
        ...
        let checkUpdateData =
            title === data.name && description === data.description && Util.compareDate(date, data.date_end);
        ...
        const result = await Service.update('/project/edit-project', formData);
    ...
    return (
        <div className="h-screen w-screen flex justify-center items-center">
            <div
                ...
                className="max-w-[50rem] z-50 relative p-4 pb-6 text-black dark:text-white bg-light-second dark:bg-dark-second rounded-md w-screen "
            >
                <div
                    onClick={action}
                ...
                <div
                    className="overflow-auto max-h-[30rem] pt-2 custom-scrollbar bd-radius-scroll pl-2 pr-2 pb-10"
