...
const DayOfWeek = ({ day, weekday, checkSameDay, date, id, tasks, year = new Date().getFullYear() }) => {
    ...
    return (
        <div
            ...
            className={`${
                day === date.getDate() && checkSameDay ? 'bg-code' : ''
        ...
        >
            <div className="flex flex-col border-b-1 border-dashed border-blur-light dark:border-blur-dark">
                <Tooltip title={`${weekday} , ngày ${day}, tháng ${currentMonth + 1}, năm ${year}`}>
