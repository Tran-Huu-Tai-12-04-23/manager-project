...
function InfoUser({ data, dataLogin, setEditProfile }) {
    return (
        <div className="mt-5 relative">
            <h1 className="font-medium mt-5">Giới thiệu về bạn</h1>
            <h1 className="font-extralight absolute right-6 top-4 mt-6 text-[#757575]">Ai có thể xem?</h1>

            <div className="relative rounded-md border-solid pt-14 dark:border-[rgba(255,255,255,0.1)] border-[rgba(0,0,0,0.1)] p-4 border-[1px]">
                <div>
