...
function MenuSideBar({ active, setActive, setPreActive }) {
    const nav = [
        {
            name: 'Tổng quan',
        ...
        {
            name: 'Cài đặt',
            icon: <AiOutlineSetting sx={{ width: 20, height: 20 }}></AiOutlineSetting>,
        },
        {
            name: 'Trợ giúp',
    ...
    return (
        <>
            <div className={`relative w-14 text-sm h-screen pt-4 flex justify-start items-start `}></div>
            <div
            ...
            >
                ...
                <div className="transition-all hover:bg-light-second cursor-pointer w-full   dark:hover:bg-dark-second mb-2 justify-center items-start flex mt-auto">
                    <Tooltip title="Đăng xuất">
                        <button onClick={handleLogOut} className="reset ml-auto mr-auto p-2 w-fit rounded-sm">
