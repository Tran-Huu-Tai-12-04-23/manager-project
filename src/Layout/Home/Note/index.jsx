...
function Note() {
    ...
    return (
        <div className="p-4 relative">
            {waitLoading && (
                <div className="absolute top-0 z-50 backdrop-blur-md bg-blur-light dark:bg-blur-dark right-0 bottom-0 left-0 flex items-center justify-center">
            ...
            {edit && (
                <div className="ml-5">
                    <Button
                        ...
                        sx={{
                            backgroundColor: 'rgba(255, 83, 74, 0.1)',
                            color: 'red',
                            width: '10rem',
                            marginLeft: 'auto',
                            marginRight: 'auto',
