...
function Login({ theme, handleThemeSwitch, setActiveLogin }) {
            ...
            await signInWithPopup(auth, new GoogleAuthProvider())
                .then(async (res) => {
                    ...
                    if (result.status === true) {
                        const userGet = JSON.parse(result.data);
                        handleSaveLogin({
                            email: userGet.email,
                            id: userGet._id,
    ...
    return (
        <div className="p-10 flex min-h-screen justify-center items-center">
            ...
            {openModalForgotPass && (
                <ModalCustom open={openModalForgotPass} setOpen={setOpenModalForgotPass}>
                    <FormForgotPassword action={(e) => setOpenModalForgotPass(false)}></FormForgotPassword>
                </ModalCustom>
            )}
            <Slide direction={'left'} duration={800}>
                <div className="max-w-40 mr-10">
                    <div className="flex justify-start items-center  mb-10 ">
                        ...
                        <h1 className="text-xl font-extrabold">Quản lý dự án và công việc nhanh hơn</h1>
                    </div>
                ...
                <div className="max-w-40 ">
                    <div className="max-w-40 rounded-xl p-10 bg-light-second dark:bg-dark-second ">
                        <div className="justify-start items-center flex">
                            <h1 className="font-family font-bold text-3xl mr-2 mb-2">Đăng nhập</h1>

                            {theme === 'light' && <LightModeIcon onClick={handleThemeSwitch}></LightModeIcon>}
                            {theme === 'dark' && <DarkModeIcon onClick={handleThemeSwitch}></DarkModeIcon>}
                        </div>
                        ...
                        <div className="w-full flex justify-between items-center mt-6">
                            <Button
                                ...
                                startIcon={<img className="h-8 scale-75" src={logo_google}></img>}
                        ...
                        <div className="w-full flex items-center justify-center mt-6 gap-10">
                            <div className="w-6/12  bg-gray-600" style={{ height: '1px' }}></div>
                        ...
                        <div className="w-full font-family mt-6 grid grid-cols-1 gap-6">
                            ...
                            <div className="grid-cols-1 grid gap-2 font-primary">
                                ...
                                <div className="flex justify-between items-center mt-5">
                                    <div className="justify-start items-center flex">
                                        <input type="checkbox" className="h-4 mr-1" id="remember"></input>
