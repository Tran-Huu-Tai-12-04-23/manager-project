    ...
    return (
        <JackInTheBox duration={500}>
            ...
            >
                ...
                {!isChangePassword && (
                    <>
                        <h5 className="font-family font-bold text-md mb-2 ">Xác nhận email của bạn</h5>
                ...
                {isChangePassword && (
                    <>
                        <h5 className="font-family font-bold text-md mb-2 ">Thay đổi mật khẩu của bạn</h5>
                        <h5 className="font-family font-bold text-xs mb-2 mt-3 ">Mật khẩu</h5>
                        <Input
                            ...
                            className={'h-8 rounded-md'}
                        ></Input>
                        <h5 className="font-family font-bold text-xs mb-2 mt-3 ">Nhập lại mật khẩu</h5>
                        <Input
                            value={password}
                            type="password"
