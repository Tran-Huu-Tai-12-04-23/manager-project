...
function ModalConfirmEmail({ codeSent, sendEmail, setCodeSent, setOpenModalConfirmEmail, email, register }) {
    ...
    return (
        <>
            <div
                ...
                className="p-4 rounded-xl text-black dark:text-white bg-light-second dark:bg-dark-second min-w-20rem"
            >
