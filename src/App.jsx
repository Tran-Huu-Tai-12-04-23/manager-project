...
function App() {
    ...
    return (
        <div className="transition-all overflow-hidden bg-light-primary dark:bg-dark-primary">
            ...
            <Router>
                <Routes>
                    <Route exact path="/" element={<Home setOpenModalAddNewProject={setOpenModalAddNewProject} />} />
                    <Route exact path="/sign" element={<Sign />} />
                    <Route
                        exact
                        path="/authentication-join"
                        element={<AuthenAcceptMember isInvite={isInvite} setIsInvite={setIsInvite} />}
                    />
                </Routes>
            </Router>
            <ToastContainer />

            <Modal setOpen={setOpenModalAddNewProject} open={openModalAddNewProject}>
                <FormAddNewProject action={(e) => setOpenModalAddNewProject(false)}></FormAddNewProject>
            </Modal>
        </div>
    );
}
